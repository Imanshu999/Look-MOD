    ...
    <div className="relative group">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded-lg bg-blue-500/10 text-store-accent">
        ...
        {apps.map((app) => (
          <div 
            ...
            className={`snap-start shrink-0 w-[280px] sm:w-[320px] p-4 rounded-2xl cursor-pointer transition-all border group-hover:border-opacity-100 ${
              darkMode 
                ? 'bg-gradient-to-tr from-slate-900/90 to-store-card/40 border-slate-800/80 hover:border-store-accent/50 hover:shadow-[0_8px_25px_rgba(59,130,246,0.15)]' 
                : 'bg-gradient-to-tr from-white to-slate-50 border-slate-200/80 hover:border-store-accent hover:shadow-[0_8px_25px_rgba(59,130,246,0.05)]'
            }`}
          >
            <div className="flex gap-3.5 items-start mb-4">
              ...
              <div className="min-w-0 flex-1">
                <span className={`text-[9px] font-mono font-bold px-2 py-0.5 rounded-full ${
                  darkMode ? 'bg-slate-800 text-blue-400' : 'bg-slate-200/50 text-blue-600'
                }`}>
                  {app.category}
                </span>
            ...
            <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-800/10">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 py-2 px-4 text-xs font-bold rounded-xl bg-store-accent hover:bg-blue-600 active:scale-95 text-white transition-all shadow-[0_2px_8px_rgba(59,130,246,0.15)]"
              >
