        ...
        >
          ...
          <div className="relative w-9 h-9 flex items-center justify-center rounded-lg overflow-hidden border border-store-accent bg-store-card/40 transition-transform group-hover:scale-105 shadow-[0_0_12px_rgba(59,130,246,0.2)]">
            {!logoError ? (
              ...
              <div className="w-full h-full flex items-center justify-center bg-gradient-to-tr from-blue-600 to-indigo-600 text-white text-sm font-bold font-display">
                LMS
              </div>
            )}
          ...
          <div className="sm:hidden block">
            <span className="font-display font-bold text-base text-store-accent">LMS</span>
          </div>
        </div>
