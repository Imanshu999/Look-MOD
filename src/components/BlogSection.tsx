      ...
      <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
        ...
        <article className={`p-6 sm:p-8 rounded-2xl border ${
          ...
          <div className={`p-4 rounded-xl border border-dashed text-xs ${
            ...
            The informative guides presented on Look Mod Store are prepared for educational and technological research purposes. All downloadable material has been pre-verified by the Takano3D team.
          </div>
        </article>
      </div>
    );
