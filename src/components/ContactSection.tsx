      ...
      {submitted ? (
        <div className={`p-8 rounded-2xl border text-center space-y-4 animate-scale-up ${
          ...
          <button
            ...
            className="px-6 py-2 rounded-xl text-xs font-semibold bg-store-accent hover:bg-blue-600 text-white transition-all cursor-pointer"
          >
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-2.5 font-bold text-xs sm:text-sm text-white rounded-xl bg-store-accent hover:bg-blue-600 transition-all flex items-center justify-center gap-2 cursor-pointer ${
              loading ? 'opacity-70 cursor-not-allowed' : 'active:scale-95 shadow-[0_2px_12px_rgba(59,130,246,0.2)]'
            }`}
          >
