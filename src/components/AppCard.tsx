    ...
    return (
      ...
      >
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-1.5 py-2 px-3 text-xs font-semibold rounded-xl bg-store-accent hover:bg-blue-600 active:scale-[0.98] text-white transition-all shadow-[0_2px_8px_rgba(59,130,246,0.2)] hover:shadow-[0_4px_12px_rgba(59,130,246,0.35)]"
        >
    ...
    >
      ...
      <div className="mt-3 sm:mt-0 w-full sm:w-auto flex items-center justify-between sm:justify-end gap-6 border-t sm:border-t-0 pt-2 sm:pt-0 border-slate-800/10">
        ...
        <button 
          ...
          className="px-3.5 py-1.5 text-xs font-bold rounded-lg bg-store-accent hover:bg-blue-600 text-white transition-all flex items-center gap-1 active:scale-95"
        >
